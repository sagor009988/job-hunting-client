    ...
    return (
        <div className='max-w-6xl mx-auto py-16'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16'>
                <div>
                    <img className='mx-auto mb-4' src="https://i.ibb.co/4gzXtv7/download-18.jpg" alt="" />
                    <div>
                ...
                <div>
                    <img className='mx-auto mb-4' src="https://i.ibb.co/GpDTpVG/images-25.jpg" alt="" />
                    <div>
                ...
                <div>
                    <img className='mx-auto mb-4' src="https://i.ibb.co/WVcYv2w/download-2.png" alt="" />
                    <div>
