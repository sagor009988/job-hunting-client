            ...
            <div className="my-16 border rounded-sm p-4 grid grid-cols-1 md:grid-cols-4 gap-0 md:gap-8 px-2 md:px-4">
                <div className="col-span-3">
                    ...
                    <form onSubmit={handleJobPost}>
                        ...
                        <label className="font-bold" htmlFor="qualification">Qualification</label><br />
                        <input className="p-1 mb-4 rounded border w-full" required type="text" name='qualification' placeholder="Qualification" /> <br />
