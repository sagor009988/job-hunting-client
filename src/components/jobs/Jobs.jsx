            ...
            <div className='py-16 max-w-6xl mx-auto'>
                <Tabs>
                                            ...
                                            <div className='flex'>
                                                ...
                                                <div className='flex gap-4 flex-col justify-center'>
                                                    ...
                                                    <div className='flex gap-6 items-center'>
                                                        <p className='text-[#1bbf73] font-semibold'>{job.postedBy}</p>
                    ...
                    <div className='flex items-center justify-center py-8'>
                        <div>
                            <button className='border-[#1bbf73] border py-1 px-4 rounded-sm hover:bg-[#1bbf73] hover:text-white font-medium'>Load More Jobs</button>
                        </div>
                    </div>
                </Tabs>
            </div>
